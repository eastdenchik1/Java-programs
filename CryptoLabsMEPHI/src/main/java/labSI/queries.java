...
public class queries {
    ...
    public void constant() {
        try {
            ...
            byte[] IV = Arrays.copyOfRange(TMP_BYTES, Integer.parseInt(props.getProperty("START")), Integer.parseInt(props.getProperty("IV_LEN")));
            ...
            byte[] SEND_BYTES = Arrays.copyOfRange(TMP_BYTES_5, Integer.parseInt(props.getProperty("START")), LEN_SENDING_BYTES);
